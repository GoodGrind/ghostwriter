...
|Excluding classes and packages|GhostWriter will not instrument code that is excluded. See <<comp-arg>>|_GHOSTWRITER_EXCLUDE_|_none_
|Excluding methods|GhostWriter will not instrument methods that are excluded. See <<comp-arg>>|_GHOSTWRITER_EXCLUDE_METHODS_|_toString, equals, hashCode, compareTo_

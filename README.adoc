...
----
dependencies {
    runtime 'io.ghostwriter:ghostwriter-rt-tracer:0.4.0-scott'
    runtime 'io.ghostwriter:ghostwriter-rt-tracer-slf4j:0.4.0-scott' // Include this as well for SLF4J based logging.
}
----
...
== GhostWriter Annotation Processor
